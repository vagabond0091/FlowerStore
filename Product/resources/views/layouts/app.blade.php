...
<body>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                   <a href="/Product" class="dropdown-item">My Product</a>
    ...
    <script src="{{ asset('storage/js/components/validation.js') }}"></script>
    ...
    <script src="{{ asset('storage/js/api/createOrder.js') }}"></script> 
    <script src="{{ asset('storage/js/api/getAllOrderByUser.js') }}"></script> 
</body>
</html>
